...
<div class="pk-mobile">
  ...
  <div class="pk-body">
    ...
    <main class="pk-main">
      <div class="pk-panel">
        <h2 class="pk-title">Hasil Kinerja</h2>

        <div class="pk-list">
          @forelse($penilaians as $item)
            <a href="{{ route('m.penilaian-kinerja.show', $item->id) }}" class="pk-item">
              <div class="pk-item-head">
                <div>
                  <div class="pk-period">{{ $item->periode_kenaikan_gaji }}</div>
                  <div class="pk-date">
                    {{ optional($item->tanggal_penilaian)->format('d-m-Y') }}
                  </div>
                </div>

                <span class="pk-badge">{{ $item->predikat ?: '-' }}</span>
              </div>

              <div class="pk-grid">
                <div class="pk-row">
                  <b>Nilai Akhir:</b> {{ $item->nilai_akhir }}
                </div>
                <div class="pk-row">
                  <b>Nominal Kenaikan Gaji:</b>
                  Rp {{ number_format($item->nominal_kenaikan_gaji, 0, ',', '.') }}
                </div>
                <div class="pk-row">
          ...
          @empty
            <div class="empty-state">
              Belum ada data penilaian kinerja.
            </div>
          @endforelse
        </div>
      </div>
